		...
		<div id="menu"><!-- Menu start-->
    		...
    		<div class="content_wrap"><!-- content_wrap start-->
   					 		...
   					 		<div id="content">
                            		...
                            		<div id="Cart">
                                	<span style="float:right; font-size:18px; color:#F60; line-height:30px; padding-right:25px;">Cart || <b>Total Itme:
									<?php  	echo "(";  getItem(); echo ")"; ?>                                             
									Total Price:$<?php Price_totle(); ?> <a href="cart.php">Go To Cart</a></b></span>
                                </div>
